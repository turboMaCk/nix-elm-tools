...
let
  sources = {
    ...
    "minipass-2.7.0" = {
      ...
      version = "2.7.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/minipass/-/minipass-2.7.0.tgz";
        sha512 = "+CbZuJ4uEiuTL9s5Z/ULkuRg1O9AvVqVvceaBrhbYHIy1R3dPO7FMmG0nZLD0//ZzZq0MUOjwdBQvk+w1JHUqQ==";
      };
    };
    "minizlib-1.2.2" = {
      name = "minizlib";
